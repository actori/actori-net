...
use actori_codec::BytesCodec;
use actori_service::{fn_factory_with_config, fn_service, IntoService, Service};
use actori_testing::TestServer;
use actori_utils::mpsc;
use bytes::{Bytes, BytesMut};
use futures::future::ok;

use actori_ioframe::{Builder, Connect, FactoryBuilder};
...
async fn test_basic() {
    ...
    let conn = actori_connect::default_connector()
        .call(actori_connect::Connect::with(String::new(), srv.addr()))
        .await
        .unwrap();
